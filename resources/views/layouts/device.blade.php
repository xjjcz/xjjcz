									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="designPower"
												value="${cur_device.designPower}" alt="p0x3p3s" class="check2"  onkeyup="checkNum(this);" 
							...
							<div class="col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="practicalPower"
												value="${cur_device.practicalPower}"  alt="p0x3p3s" class="check2"   onkeyup="checkNum(this);" 
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" name="yearrunDays" id="yearrunDays" alt="p3x3p0s" class="check2"   onkeyup="checkNum(this);" 
												value="${cur_device.yearrunDays}"  style="width: 300px;" onblur="IsChangeNew(this.id,0,365,'全年运行天数')" Onchange="ischanged('practicalPower')"/>
