...
function cjdetele() {
	...
	$.post("ajax/RongjiProductTemp/cjdetele.do", {
		cjexfid : cjexfid
	}, function(data) {
		var json = eval("(" + data + ")");
		//alert(json.sys_code);
...
function cancel() {
	...
	//获取当前页
	var newpage = parseInt('${newrongjiproduct}');
	var m_pages = parseInt(document.getElementById("page").value);
	if (newpage == 1) {
		var number = parseInt('${totalrongji.productNum}') - 1;
...
function checkvalue(witch) {
	...
	var contents = new Array("生产活动类别", "产品名称/类别", "生产/排污工艺", "计量单位", "年产量",
			"产品1月份产量", "产品2月份产量", "产品3月份产量", "产品4月份产量", "产品5月份产量", "产品6月份产量",
			"产品7月份产量", "产品8月份产量", "产品9月份产量", "产品10月份产量", "产品11月份产量", "产品12月份产量");
	...
	return 2;
		...
		<script type="text/javascript">
/*function sccselect1(wh,value_a){
      document.getElementById("isrongji").value=wh;
      if(wh==0){
     		 
      	    $("#activitiesCategory").val("");
      		$("#activitiesCategory option[value='']").attr(
				"selected", true);
		
		clientscc3('11',value_a,'nameCategory','drainageProcess');
		
      }else{
      	$("#activitiesCategory1").val("");
    	 $("#activitiesCategory1 option[value='']").attr(
				"selected", true);
		clientscc3('14',value_a,'nameCategory','drainageProcess');
		
      }
     
   }
   function sccselect2(value_a){
   	var isrongji=document.getElementById("isrongji").value;
   	//alert(isrongji);
   	if(isrongji==0){
   			clientscc4('11','activitiesCategory',value_a,'drainageProcess')
   	}else{
   			clientscc4('14','activitiesCategory1',value_a,'drainageProcess')
   	}
   }*/
function updatedata() {
	...
	$.post("ajax/RongjiProductTemp/updatedb.do", {
		isnew : 0,
		name : name,
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="activitiesCategory_input"
											...
											value='${cur_rongji.activitiesCategory}' />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="nameCategory_input"
											id="nameCategory_input" value='${cur_rongji.nameCategory}' />
										<div class="col-md-8">
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="drainageProcess_input"
											...
											value='${cur_rongji.drainageProcess}' />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="name" value="${cur_rongji.name}"
							...
							<div class="col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" name="annualOutput" id="annualOutput"
												...
												value="${cur_rongji.annualOutput}" class="col-md-11"
												style="width: 300px;" />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="uint" value="${cur_rongji.uint}"
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" name="factorVoc" id="factorVoc"
											class="check1" alt="p5x3p4s"
											value="${cur_rongji.factorVoc}" class="col-md-11"
											style="width: 300px;" />
