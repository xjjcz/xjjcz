...
$(document)
		.ready(function() {
            ...
            var real_rongji_raw_num = total_rongji_temp.length==0?0:total_rongji_temp[0]["raw_num"];
				...
				$('#m_alert').hide();
				//var page_show = parseInt(page);
				var page_show = {!! $NUM !!};
				//	var isrongji=document.getElementById("isrongji").value;//cur_rongji.scc2

				//判断加载那种scc编码

				//innitSccbb("14","activitiesCategory1");


				document.getElementById("NO").innerHTML = "<b>" + page_show
						+ "号原料</b>";
				//page从100开始加
				//有设备1，原料201，原料101
				...
				// 如果当前页面是最后一页，下一步不显
				if (page_show == rongji_raw_num) {
					$('#nextpage').hide();
					$('#detelepage').show();
					var newpage = rongji_raw_num-real_rongji_raw_num;
					if (newpage == 1) {
						$('#detelepage').hide();
					} else {
						$('#detelepage').show();
...
function cjdetele() {
	...
	$.post("ajax/RongjiRawTemp/cjdetele.do", {
		cjexfid : cjexfid
	}, function(data) {
		var json = eval("(" + data + ")");
		//alert(json.sys_code);
...
function jumpsave(source) {
	...
	return jumpandsave(source, 'rongji', m_alert);
}
...
function jumptopage(page) {
	...
	$.post("ajax/TotalRongjiTemp/savepagejump.do", {
				cjnub : page
			}, function(data) {
				var json = eval("(" + data + ")");
				//alert(json.sys_code);
...
function cancel() {
	...
	//获取当前页
	var newpage = parseInt('${newrongjiraw}');
	var m_pages = parseInt(document.getElementById("page").value);

	var total = parseInt('${totalrongji.rawNum}');

	if (newpage == 1) {
		var number = parseInt('${totalrongji.rawNum}') - 1;
		// alert(number);

		if (window.confirm(alertnew)) {
			$.post("ajax/TotalRongjiTemp/savetotalraw.do", {
				totalraw : number,
				newrongjiraw : 0
			}, function(data) {
			});
...
function checkvalue(witch) {
	...
	var contents = new Array("生产活动类别", "原料名称/类别", "生产/排污工艺", "计量单位", "年使用量",
			"原料1月份使用量", "原料2月份使用量", "原料3月份使用量", "原料4月份使用量", "原料5月份使用量",
			"原料6月份使用量", "原料7月份使用量", "原料8月份使用量", "原料9月份使用量", "原料10月份使用量",
			"原料11月份使用量", "原料12月份使用量");
	...
	//生产活动类别a	原料名称/类别b	原料备注c	生产/排污工艺d	计量单位e	年使用量	对应装置编号
	return 2;
...
function updatedata() {
	...
	var everyMUseamount = janUseamount + febUseamount + marUseamount
			+ aprUseamount + mayUseamount + juneUseamount + julyUseamount
			+ augUseamount + septUseamount + octUseAmount + novUseamount
			+ decUseamount;
	...
	$.post("ajax/RongjiRawTemp/updatedb.do", {
		...
		//alert(json.sys_code);
			if (json.sys_code == "suc") {
				...
				document.getElementById("malert").value = 0;
				$('#m_alert').hide();
				saveinfo(page, source, 'rongji', m_alert);
			}
		});
						...
						<div class="row" style="height: 11px;">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="activitiesCategory_input"
											id="activitiesCategory_input" value='${cur_rongji.scc2}' />

										<div class="col-md-8">

											<select id="activitiesCategory" style="width: 300px;"
												Onchange="clientscc3('14',this.value,'nameCategory','drainageProcess')" />
											</select>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="nameCategory_input"
											id="nameCategory_input" value='${cur_rongji.scc3}' />


										<div class="col-md-8">
											<select id="nameCategory" style="width: 300px;"
												Onchange="clientscc4('14','activitiesCategory',this.value,'drainageProcess')" />
											</select>
							...
							<div class="col-xs-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="drainageProcess_input"
											id="drainageProcess_input" value='${cur_rongji.scc4}' />

										<div class="col-md-8">
											<select id="drainageProcess" style="width: 300px" />
											</select>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="name" value="${cur_rongji.mname}"
							...
							<div class="col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" name="annualOutput" id="annualOutput"
												Onchange="ischanged('deviceFlow')" class="check1"
												alt="p9x3p4s" value="${cur_rongji.musage}"
												style="width: 300px;"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" id="uint" value="${cur_rongji.unit}"
							...
							<div class="col-xs-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.gasNo}" type="text" maxlength="15"
												class="check1" alt="p3x3p0s" id="gasNo"
												Onchange="ischanged('deviceFlow')" style="width: 300px;" />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.gasPre}" type="text"
												class="check1" alt="p2x3p2s" id="gasPre"
												Onchange="ischanged('deviceFlow')" style="width: 300px;" />
							...
							<div class="col-xs-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.gasVocs}" type="text"
												class="check1" alt="p2x3p2s" id="gasVocs"
												Onchange="ischanged('deviceFlow')" style="width: 300px;" />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.treatPre}" type="text"
												class="check1" alt="p2x3p2s" id="treatPre"
												Onchange="ischanged('deviceFlow')" style="width: 300px;" />
							...
							<!-- <div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-8">
													<input value="${cur_rongji.treatNo}" type="text"  
														id="treatNo"
														 style="width: 300px;"
														/>
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.janUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.febUseamount}" type="text"
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.marUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.aprUseamount}" type="text"
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.mayUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.juneUseamount}" type="text"
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.julyUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.augUseamount}" type="text"
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.septUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.octUseAmount}" type="text"
							...
							<div class="col-xs-12">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.novUseamount}" type="text"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input value="${cur_rongji.decUseamount}" type="text"
									...
									<ul class="pager">
										<li class="col-md-3">
											<a href="javascript:void(0);" id="prepage"
												style="font-weight: bold;" onclick="pre();">&larr; 填报上一个</a>
										</li>
										<div class="col-md-3">
											<li>
										...
										<li class="col-md-3">
											<a href="javascript:void(0);" id="nextpage"
												style="font-weight: bold;" onclick="next();">填报下一个
												&rarr;</a>
										</li>
